<?php
// Função para obter os títulos simples dos filmes com tempo de exibição menor que 100 minutos.
function simple_titleME()
{
    ...
    if (($handle = fopen($filename, 'r')) !== FALSE) {
        ...
        while (($data = fgetcsv($handle)) !== FALSE && $linha_atual < $numero_da_linha) {
            ...
            // Verifica se o tempo de exibição é menor que 100 minutos.
...
// Função para obter os tempos de exibição dos filmes com runtime menor que 100 minutos.
function runtime_minutesME()
{
    ...
    if (($handle = fopen($filename, 'r')) !== FALSE) {
        ...
        // Obtém os índices das colunas "runtime_minutes".
        $indexTempo_exibicao = array_search('runtime_minutes', $header);
...
// Função para obter os votos dos filmes com runtime menor que 100 minutos.
...
// Função para obter as avaliações médias dos filmes com runtime menor que 100 minutos.
